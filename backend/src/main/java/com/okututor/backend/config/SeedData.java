...
public class SeedData implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        // Marketplace: both tutor and student are USER (hasResume determines provider)
        User tutor = user("tutor@test.com", "Tutor", "User", Role.USER,
        ...
        User student = user("test@test.com", "Test", "User", Role.USER,
