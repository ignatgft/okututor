...
/**
 * @deprecated LEGACY EdTech — marketplace uses TutorProfile/TutorRequest/Chat. Kept for backward compatibility; new marketplace code must not depend on Course.
 */
@Deprecated
@RestController
