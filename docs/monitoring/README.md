...
## Relation to `metrics/` (удалена)

Папка `metrics/` (Tempo, Alloy, postgres/redis exporters) **удалена 2026-09-17**. Единый стек — `monitoring/` (1 Dokploy Application, 6 контейнеров). См. `backend/docs/monitoring/README.md`.
