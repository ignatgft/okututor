...
export const OPEN_STATUSES = [TICKET_STATUS.OPEN, TICKET_STATUS.IN_PROGRESS, TICKET_STATUS.WAITING_FOR_USER, TICKET_STATUS.WAITING_FOR_SUPPORT];
export const CLOSED_STATUSES = [TICKET_STATUS.RESOLVED, TICKET_STATUS.CLOSED];
