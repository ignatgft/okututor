...
/**
 * Student-side booking modal. Lets the student pick a date and a time slot
 * (driven by the tutor's availability when provided, else free-form), choose
 * a duration, and create a booking through bookingApi.create().
 */
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        else setError(data?.error || data?.message || t("booking.error", "Failed to create booking"));
      }
    } catch (err) {
