...
import { GraduationCap, Calendar, BookOpen, Users, MessageCircle, Search, User, Bell, Inbox, AlertTriangle } from "lucide-react";
...
export function ErrorState({ message, onRetry }: ErrorStateProps): JSX.Element {
  return (
    <div className="empty-state error-state" role="alert">
      <span className="empty-state-icon" aria-hidden="true"><AlertTriangle size={32} /></span>
      <p>{message}</p>
