...
export default function ResendCodeButton({ resendAvailableIn = 60, onResend, loading = false }: ResendCodeButtonProps): JSX.Element {
  const { t } = useTranslation();
  const [secondsLeft, setSecondsLeft] = useState<number>(Math.max(0, resendAvailableIn));
