...
export const SIDEBAR_ITEMS: Record<RoleKey, NavItem[]> = {
  ...
  admin: [
    ...
    { id: "admin_messages", labelKey: "navbar.messages", icon: Inbox, path: "/app/messages" },
...
export const BOTTOMNAV_ITEMS: Record<RoleKey, NavItem[]> = {
  ...
  admin: [
    ...
    { id: "messages", path: "/app/messages", labelKey: "navbar.messages", icon: Inbox },
...
export const PAGE_TITLES: Record<RoleKey, Record<string, string>> = {
  ...
  admin: {
    ...
    "/admin/seo": "admin.seo",
    "/app/messages": "navbar.messages",
    "/app/messages/:id": "navbar.messages",
