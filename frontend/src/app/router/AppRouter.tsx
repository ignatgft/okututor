...
const PgAdminLegal = lazy(() => import("../../pages/PgAdminLegal"));
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/repetitor/:subject/:slug" element={withBoundary(<PgTutorMarketplace />)} />
        <Route path="/repetitor/:slug" element={withBoundary(<PgTutorMarketplace />)} />
        ...
        <Route element={<ProtectedRoute roles={["USER", "ADMIN", "SUPER_ADMIN", "STUDENT", "TUTOR"]} />}>
          <Route element={<UserDashboardLayout />}>
            ...
            <Route path="/dashboard/resume/edit" element={withBoundary(<PgResumeEditor />)} />
            <Route path="/dashboard/resume/preview" element={withBoundary(<PgResumePreview />)} />
            <Route path="/dashboard/favorites" element={withBoundary(<PgFavorites />)} />
